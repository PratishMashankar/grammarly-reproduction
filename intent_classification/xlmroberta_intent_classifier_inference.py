...
from transformers import Trainer, TrainingArguments, XLMRobertaTokenizer, XLMRobertaModel, XLMRobertaConfig, XLMRobertaForSequenceClassification

def main(args):
    checkpoint = args.checkpoint
    model_name = 'xlm-roberta-large'
    model_cache_dir='xlm-roberta-large-model-cache/'
    model_type = XLMRobertaForSequenceClassification
    config_type = XLMRobertaConfig
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', '-c', required=True,
                        help='path to XLM-RoBERTa model checkpoint')
